      ...
      <div className="flex w-3/4 min-h-full rounded-3xl shadow-lg m-auto bg-gray-100">
        ...
        <div className="form-container">
          ...
          <div className="flex flex-col items-center justify-center h-full">
            <h1 className="text-white text-2xl">How is  Weather of Your City?</h1>
            <hr className="h-1 bg-white w-1/4 rounded-full my-5" />
            <form noValidate onSubmit={handleSubmit} className="flex justify-center w-full">
              <input type="text" 
                placeholder="Enter location" 
                className="relative rounded-xl py-2 px-3 w-2/3 bg-gray-300 bg-opacity-60 text-black placeholder-gray-200"
              ...
              <i className="fa fa-map-marker-alt my-auto cursor-pointer p-3 text-black" aria-hidden="true" onClick={() => {
        ...
        <div className="w-2/4 p-5">
          ...
          <div className="flex flex-col my-10">
            ...
            {weatherData.length === 0 ? 
              ...
              <>
                <h1 className="text-5xl text-gray-800 mt-auto mb-4">Today-{city}</h1>
